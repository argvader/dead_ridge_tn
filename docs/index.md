...
Out here, in these mountains, the dead are the least complicated thing you'll face.

This is the session archive and campaign wiki for **Dead Ridge, TN** — a
*Walking Dead Universe Roleplaying Game* campaign set in the Tennessee and
Georgia mountains, five years after the outbreak. It's a record of who the
...
1. Run session zero: the Unsetting Questions, haven selection, and character
   creation. Record the answers into `world/world.md`.
2. Record and transcribe the session (see `README.md`), then drop the materials
   into `sessions-raw/<DATE>/`.
3. Run the **summarize latest session** skill to generate the session page and
   the survivor, group, and location wiki entries, then **build world data** to
   rebuild this home page.
